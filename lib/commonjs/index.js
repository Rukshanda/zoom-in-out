...
var ScrollInverted = /** @class */ (function (_super) {
    ...
    ScrollInverted.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, style = _a.style, classNameContentContainer = _a.classNameContentContainer, _b = _a.styleContentContainer, styleContentContainer = _b === void 0 ? {} : _b, styleWrap = _a.styleWrap, classNameWrap = _a.classNameWrap, renderItem = _a.renderItem, _c = _a.data, data = _c === void 0 ? [] : _c, keyExtractor = _a.keyExtractor;
        return (jsxRuntime.jsx("div", __assign({ className: clsx("scroll-inverted-wrap", classNameWrap), style: styleWrap }, { children: jsxRuntime.jsx("div", __assign({ className: clsx("scroll-inverted-container", className), ref: function (ref) { return (_this.divScroll = ref); }, style: style, onScroll: this.onScrollMobile }, { children: jsxRuntime.jsx("div", __assign({ style: __assign(__assign({}, styleContentContainer), { position: "relative" }), className: clsx("scroll-inverted-content", classNameContentContainer), ref: function (ref) { return (_this.divContentWrap = ref); } }, { children: jsxRuntime.jsx("div", __assign({ ref: function (ref) { return (_this.divContent = ref); } }, { children: data.map(function (item, index) { return (jsxRuntime.jsx(ItemRenderring, { children: renderItem === null || renderItem === void 0 ? void 0 : renderItem({ item: item, index: index }) }, (keyExtractor === null || keyExtractor === void 0 ? void 0 : keyExtractor(item, index)) || index)); }) })) })) })) })));
    };
