...
var Slick = /** @class */ (function (_super) {
    ...
    function Slick(props) {
        ...
        _this.addLoop = function (props) {
            if (props === void 0) { props = _this.props; }
            clearInterval(_this.interval);
            var _a = props.durationAutoPlay, durationAutoPlay = _a === void 0 ? 4000 : _a, _b = props.durationAnimation, durationAnimation = _b === void 0 ? 300 : _b, _c = props.images, images = _c === void 0 ? [] : _c, _d = props.loop, loop = _d === void 0 ? true : _d, onNext = props.onNext;
            if (!loop)
                return;
            _this.interval = setInterval(function () {
                ...
                setTimeout(function () {
                    ...
                    onNext === null || onNext === void 0 ? void 0 : onNext(images[_this.i - 1], _this.i - 1);
